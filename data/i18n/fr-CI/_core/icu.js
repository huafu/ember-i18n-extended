var container = {};(function() {
	...
	icu.getCountry = function() { return "CI" };
	icu.getCountryName = function() { return "Côte d’Ivoire" };
	...
	icu.getLocale = function() { return "fr-CI" };
	icu.getLocaleName = function() { return "français (Côte d’Ivoire)" };
