var container = {};(function() {
	...
	var dfs = {"am_pm":["ǁgoagas","ǃuias"],"day_name":["Sontaxtsees","Mantaxtsees","Denstaxtsees","Wunstaxtsees","Dondertaxtsees","Fraitaxtsees","Satertaxtsees"],"day_short":["Son","Ma","De","Wu","Do","Fr","Sat"],"era":["BC","AD"],"era_name":["Xristub aiǃâ","Xristub khaoǃgâ"],"month_name":["ǃKhanni","ǃKhanǀgôab","ǀKhuuǁkhâb","ǃHôaǂkhaib","ǃKhaitsâb","Gamaǀaeb","ǂKhoesaob","Aoǁkhuumûǁkhâb","Taraǀkhuumûǁkhâb","ǂNûǁnâiseb","ǀHooǂgaeb","Hôasoreǁkhâb"],"month_short":["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "NA" };
	icu.getCountryName = function() { return "Namibiab" };
	...
	icu.getLanguage = function() { return "naq" };
	icu.getLanguageName = function() { return "Khoekhoegowab" };
