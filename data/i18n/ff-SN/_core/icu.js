var container = {};(function() {
	...
	var dfs = {"am_pm":["subaka","kikiiɗe"],"day_name":["dewo","aaɓnde","mawbaare","njeslaare","naasaande","mawnde","hoore-biir"],"day_short":["dew","aaɓ","maw","nje","naa","mwd","hbi"],"era":["H-I","C-I"],"era_name":["Hade Iisa","Caggal Iisa"],"month_name":["siilo","colte","mbooy","seeɗto","duujal","korse","morso","juko","siilto","yarkomaa","jolal","bowte"],"month_short":["sii","col","mbo","see","duu","kor","mor","juk","slt","yar","jol","bow"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "SN" };
	icu.getCountryName = function() { return "Senegaal" };
	...
	icu.getLanguage = function() { return "ff" };
	icu.getLanguageName = function() { return "Pulaar" };
