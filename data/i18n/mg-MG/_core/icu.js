var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Alahady","Alatsinainy","Talata","Alarobia","Alakamisy","Zoma","Asabotsy"],"day_short":["Alah","Alats","Tal","Alar","Alak","Zom","Asab"],"era":["BC","AD"],"era_name":["Alohan'i JK","Aorian'i JK"],"month_name":["Janoary","Febroary","Martsa","Aprily","Mey","Jona","Jolay","Aogositra","Septambra","Oktobra","Novambra","Desambra"],"month_short":["Jan","Feb","Mar","Apr","Mey","Jon","Jol","Aog","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "MG" };
	icu.getCountryName = function() { return "Madagasikara" };
	...
	icu.getLanguage = function() { return "mg" };
	icu.getLanguageName = function() { return "Malagasy" };
