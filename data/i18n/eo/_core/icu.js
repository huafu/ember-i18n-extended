var container = {};(function() {
	...
	var dfs = {"am_pm":["atm","ptm"],"day_name":["dimanĉo","lundo","mardo","merkredo","ĵaŭdo","vendredo","sabato"],"day_short":["di","lu","ma","me","ĵa","ve","sa"],"era":["aK","pK"],"era_name":["aK","pK"],"month_name":["januaro","februaro","marto","aprilo","majo","junio","julio","aŭgusto","septembro","oktobro","novembro","decembro"],"month_short":["jan","feb","mar","apr","maj","jun","jul","aŭg","sep","okt","nov","dec"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "eo" };
	icu.getLanguageName = function() { return "esperanto" };
