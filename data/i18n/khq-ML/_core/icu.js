var container = {};(function() {
	...
	var dfs = {"am_pm":["Adduha","Aluula"],"day_name":["Alhadi","Atini","Atalata","Alarba","Alhamiisa","Aljuma","Assabdu"],"day_short":["Alh","Ati","Ata","Ala","Alm","Alj","Ass"],"era":["IJ","IZ"],"era_name":["Isaa jine","Isaa jamanoo"],"month_name":["Žanwiye","Feewiriye","Marsi","Awiril","Me","Žuweŋ","Žuyye","Ut","Sektanbur","Oktoobur","Noowanbur","Deesanbur"],"month_short":["Žan","Fee","Mar","Awi","Me","Žuw","Žuy","Ut","Sek","Okt","Noo","Dee"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "khq" };
	icu.getLanguageName = function() { return "Koyra ciini" };
