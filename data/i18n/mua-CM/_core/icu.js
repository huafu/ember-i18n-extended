var container = {};(function() {
	...
	var dfs = {"am_pm":["comme","lilli"],"day_name":["Com'yakke","Comlaaɗii","Comzyiiɗii","Comkolle","Comkaldǝɓlii","Comgaisuu","Comzyeɓsuu"],"day_short":["Cya","Cla","Czi","Cko","Cka","Cga","Cze"],"era":["KK","PK"],"era_name":["KǝPel Kristu","Pel Kristu"],"month_name":["Fĩi Loo","Cokcwaklaŋne","Cokcwaklii","Fĩi Marfoo","Madǝǝuutǝbijaŋ","Mamǝŋgwãafahbii","Mamǝŋgwãalii","Madǝmbii","Fĩi Dǝɓlii","Fĩi Mundaŋ","Fĩi Gwahlle","Fĩi Yuru"],"month_short":["FLO","CLA","CKI","FMF","MAD","MBI","MLI","MAM","FDE","FMU","FGW","FYU"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "kameruŋ" };
	...
	icu.getLanguage = function() { return "mua" };
	icu.getLanguageName = function() { return "MUNDAŊ" };
