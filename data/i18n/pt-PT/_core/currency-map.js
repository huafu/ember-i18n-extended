...
UrlUtil.getGlobalDirectory()=http://www.localeplanet.com/api/pt-PT/
UrlUtil.getGlobalPath()=http://www.localeplanet.com/api/pt-PT/currencymap.json
UrlUtil.getGlobalUrl()=http://www.localeplanet.com/api/pt-PT/currencymap.json?name=Y
UrlUtil.getLocalDirectory()=/api/pt-PT/
UrlUtil.getLocalFile()=currencymap.json
UrlUtil.getLocalPath()=/api/pt-PT/currencymap.json
UrlUtil.getLocalUrl()=/api/pt-PT/currencymap.json?name=Y
...
javax.servlet.forward.request_uri=/api/pt-PT/currencymap.json (type=java.lang.String)
javax.servlet.forward.servlet_path=/api/pt-PT/currencymap.json (type=java.lang.String)
...
org.mortbay.jetty.newSessionId=13yh09yh7r0if (type=java.lang.String)
org.tuckey.web.filters.urlrewrite.RuleMatched=true (type=java.lang.Boolean)
urlparam=pt-PT (type=java.lang.String)

SESSION
=======
created on Wed Mar 25 00:50:07 UTC 2015
(none)
