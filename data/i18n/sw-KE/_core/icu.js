var container = {};(function() {
	...
	var dfs = {"am_pm":["asubuhi","alasiri"],"day_name":["Jumapili","Jumatatu","Jumanne","Jumatano","Alhamisi","Ijumaa","Jumamosi"],"day_short":["J2","J3","J4","J5","Alh","Ij","J1"],"era":["KK","BK"],"era_name":["Kabla ya Kristo","Baada ya Kristo"],"month_name":["Januari","Februari","Machi","Aprili","Mei","Juni","Julai","Agosti","Septemba","Oktoba","Novemba","Desemba"],"month_short":["Jan","Feb","Mac","Apr","Mei","Jun","Jul","Ago","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "sw" };
	icu.getLanguageName = function() { return "Kiswahili" };
	icu.getLocale = function() { return "sw-KE" };
	icu.getLocaleName = function() { return "Kiswahili (Kenya)" };
