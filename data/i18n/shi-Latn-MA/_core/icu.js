var container = {};(function() {
	...
	var dfs = {"am_pm":["tifawt","tadggʷat"],"day_name":["asamas","aynas","asinas","akṛas","akwas","asimwas","asiḍyas"],"day_short":["asa","ayn","asi","akṛ","akw","asim","asiḍ"],"era":["daɛ","dfɛ"],"era_name":["dat n ɛisa","dffir n ɛisa"],"month_name":["innayr","bṛayṛ","maṛṣ","ibrir","mayyu","yunyu","yulyuz","ɣuct","cutanbir","ktubr","nuwanbir","dujanbir"],"month_short":["inn","bṛa","maṛ","ibr","may","yun","yul","ɣuc","cut","ktu","nuw","duj"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "lmɣrib" };
	...
	icu.getLanguageName = function() { return "tamazight" };
	icu.getLocale = function() { return "shi-Latn-MA" };
	icu.getLocaleName = function() { return "tamazight (Latn, lmɣrib)" };
