var container = {};(function() {
	...
	var dfs = {"am_pm":["Subbaahi","Zaarikay b"],"day_name":["Alhadi","Atinni","Atalaata","Alarba","Alhamisi","Alzuma","Asibti"],"day_short":["Alh","Ati","Ata","Ala","Alm","Alz","Asi"],"era":["IJ","IZ"],"era_name":["Isaa jine","Isaa zamanoo"],"month_name":["Žanwiye","Feewiriye","Marsi","Awiril","Me","Žuweŋ","Žuyye","Ut","Sektanbur","Oktoobur","Noowanbur","Deesanbur"],"month_short":["Žan","Fee","Mar","Awi","Me","Žuw","Žuy","Ut","Sek","Okt","Noo","Dee"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "dje" };
	icu.getLanguageName = function() { return "Zarmaciine" };
	icu.getLocale = function() { return "dje" };
	icu.getLocaleName = function() { return "Zarmaciine" };
