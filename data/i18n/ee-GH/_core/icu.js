var container = {};(function() {
	...
	var dfs = {"am_pm":["ŋdi","ɣetrɔ"],"day_name":["kɔsiɖa","dzoɖa","blaɖa","kuɖa","yawoɖa","fiɖa","memleɖa"],"day_short":["kɔs","dzo","bla","kuɖ","yaw","fiɖ","mem"],"era":["hY","Yŋ"],"era_name":["Hafi Yesu Va Do ŋgɔ","Yesu Ŋɔli"],"month_name":["dzove","dzodze","tedoxe","afɔfĩe","dama","masa","siamlɔm","deasiamime","anyɔnyɔ","kele","adeɛmekpɔxe","dzome"],"month_short":["dzv","dzd","ted","afɔ","dam","mas","sia","dea","any","kel","ade","dzm"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Ghana nutome" };
	...
	icu.getLanguage = function() { return "ee" };
	icu.getLanguageName = function() { return "eʋegbe" };
	icu.getLocale = function() { return "ee-GH" };
