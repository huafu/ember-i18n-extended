var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Dydd Sul","Dydd Llun","Dydd Mawrth","Dydd Mercher","Dydd Iau","Dydd Gwener","Dydd Sadwrn"],"day_short":["Sul","Llun","Maw","Mer","Iau","Gwen","Sad"],"era":["CC","OC"],"era_name":["Cyn Crist","Oed Crist"],"month_name":["Ionawr","Chwefror","Mawrth","Ebrill","Mai","Mehefin","Gorffenaf","Awst","Medi","Hydref","Tachwedd","Rhagfyr"],"month_short":["Ion","Chwef","Mawrth","Ebrill","Mai","Meh","Gorff","Awst","Medi","Hyd","Tach","Rhag"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Prydain Fawr" };
	...
	icu.getLanguageName = function() { return "Cymraeg" };
	icu.getLocale = function() { return "cy-GB" };
	icu.getLocaleName = function() { return "Cymraeg (Prydain Fawr)" };
