var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["базар","базар ертәси","чәршәнбә ахшамы","чәршәнбә","ҹүмә ахшамы","ҹүмә","шәнбә"],"day_short":["базар","базар ертәси","чәршәнбә ахшамы","чәршәнбә","ҹүмә ахшамы","ҹүмә","шәнбә"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["јанвар","феврал","март","апрел","май","ијун","ијул","август","сентјабр","октјабр","нојабр","декабр"],"month_short":["јанвар","феврал","март","апрел","май","ијун","ијул","август","сентјабр","октјабр","нојабр","декабр"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "AZ" };
	icu.getCountryName = function() { return "Азәрбајҹан" };
	...
	icu.getLanguage = function() { return "az" };
	icu.getLanguageName = function() { return "Азәрбајҹан" };
	icu.getLocale = function() { return "az-Cyrl-AZ" };
	icu.getLocaleName = function() { return "Азәрбајҹан (kiril, Азәрбајҹан)" };
