var container = {};(function() {
	...
	var dfs = {"am_pm":["RW","TŊ"],"day_name":["Cäŋ kuɔth","Jiec la̱t","Rɛw lätni","Diɔ̱k lätni","Ŋuaan lätni","Dhieec lätni","Bäkɛl lätni"],"day_short":["Cäŋ","Jiec","Rɛw","Diɔ̱k","Ŋuaan","Dhieec","Bäkɛl"],"era":["AY","ƐY"],"era_name":["A ka̱n Yecu ni dap","Ɛ ca Yecu dap"],"month_name":["Tiop thar pɛt","Pɛt","Duɔ̱ɔ̱ŋ","Guak","Duät","Kornyoot","Pay yie̱tni","Tho̱o̱r","Tɛɛr","Laath","Kur","Tio̱p in di̱i̱t"],"month_short":["Tiop","Pɛt","Duɔ̱ɔ̱","Guak","Duä","Kor","Pay","Thoo","Tɛɛ","Laa","Kur","Tid"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "SD" };
	icu.getCountryName = function() { return "Sudan" };
	...
	icu.getLanguage = function() { return "nus" };
	icu.getLanguageName = function() { return "Thok Nath" };
	icu.getLocale = function() { return "nus-SD" };
	icu.getLocaleName = function() { return "Thok Nath (Sudan)" };
