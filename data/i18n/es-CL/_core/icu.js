var container = {};(function() {
	...
	icu.getCountry = function() { return "CL" };
	icu.getCountryName = function() { return "Chile" };
	...
	icu.getLocale = function() { return "es-CL" };
	icu.getLocaleName = function() { return "español (Chile)" };
