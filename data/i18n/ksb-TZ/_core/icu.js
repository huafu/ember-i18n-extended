var container = {};(function() {
	...
	var dfs = {"am_pm":["makeo","nyiaghuo"],"day_name":["Jumaapii","Jumaatatu","Jumaane","Jumaatano","Alhamisi","Ijumaa","Jumaamosi"],"day_short":["Jpi","Jtt","Jmn","Jtn","Alh","Iju","Jmo"],"era":["KK","BK"],"era_name":["Kabla ya Klisto","Baada ya Klisto"],"month_name":["Januali","Febluali","Machi","Aplili","Mei","Juni","Julai","Agosti","Septemba","Oktoba","Novemba","Desemba"],"month_short":["Jan","Feb","Mac","Apr","Mei","Jun","Jul","Ago","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "ksb" };
	icu.getLanguageName = function() { return "Kishambaa" };
