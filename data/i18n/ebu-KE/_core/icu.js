var container = {};(function() {
	...
	var dfs = {"am_pm":["KI","UT"],"day_name":["Kiumia","Njumatatu","Njumaine","Njumatano","Aramithi","Njumaa","NJumamothii"],"day_short":["Kma","Tat","Ine","Tan","Arm","Maa","NMM"],"era":["MK","TK"],"era_name":["Mbere ya Kristo","Thutha wa Kristo"],"month_name":["Mweri wa mbere","Mweri wa kaĩri","Mweri wa kathatũ","Mweri wa kana","Mweri wa gatano","Mweri wa gatantatũ","Mweri wa mũgwanja","Mweri wa kanana","Mweri wa kenda","Mweri wa ikũmi","Mweri wa ikũmi na ũmwe","Mweri wa ikũmi na Kaĩrĩ"],"month_short":["Mbe","Kai","Kat","Kan","Gat","Gan","Mug","Knn","Ken","Iku","Imw","Igi"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "ebu" };
	icu.getLanguageName = function() { return "Kĩembu" };
