var container = {};(function() {
	...
	var dfs = {"am_pm":["Lwamilawu","Pashamihe"],"day_name":["Mulungu","Jumatatu","Jumanne","Jumatano","Alahamisi","Ijumaa","Jumamosi"],"day_short":["Mul","Jtt","Jnn","Jtn","Alh","Iju","Jmo"],"era":["AK","PK"],"era_name":["Ashanali uKilisito","Pamwandi ya Kilisto"],"month_name":["Mupalangulwa","Mwitope","Mushende","Munyi","Mushende Magali","Mujimbi","Mushipepo","Mupuguto","Munyense","Mokhu","Musongandembwe","Muhaano"],"month_short":["Mup","Mwi","Msh","Mun","Mag","Muj","Msp","Mpg","Mye","Mok","Mus","Muh"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Tansaniya" };
	...
	icu.getLanguage = function() { return "sbp" };
	icu.getLanguageName = function() { return "Ishisangu" };
