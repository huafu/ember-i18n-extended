var container = {};(function() {
	...
	var dfs = {"am_pm":["Zdat azal","Ḍeffir aza"],"day_name":["Asamas","Aynas","Asinas","Akras","Akwas","Asimwas","Asiḍyas"],"day_short":["Asa","Ayn","Asn","Akr","Akw","Asm","Asḍ"],"era":["ZƐ","ḌƐ"],"era_name":["Zdat Ɛisa (TAƔ)","Ḍeffir Ɛisa (TAƔ)"],"month_name":["Yennayer","Yebrayer","Mars","Ibrir","Mayyu","Yunyu","Yulyuz","Ɣuct","Cutanbir","Kṭuber","Nwanbir","Dujanbir"],"month_short":["Yen","Yeb","Mar","Ibr","May","Yun","Yul","Ɣuc","Cut","Kṭu","Nwa","Duj"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Meṛṛuk" };
	...
	icu.getLanguage = function() { return "tzm" };
	icu.getLanguageName = function() { return "Tamaziɣt" };
	icu.getLocale = function() { return "tzm-Latn-MA" };
	icu.getLocaleName = function() { return "Tamaziɣt (Latn, Meṛṛuk)" };
