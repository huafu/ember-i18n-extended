var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Svondo","Muvhuro","Chipiri","Chitatu","China","Chishanu","Mugovera"],"day_short":["Svo","Muv","Chip","Chit","Chin","Chis","Mug"],"era":["BC","AD"],"era_name":["Kristo asati auya","Kristo ashaya"],"month_name":["Ndira","Kukadzi","Kurume","Kubvumbi","Chivabvu","Chikumi","Chikunguru","Nyamavhuvhu","Gunyana","Gumiguru","Mbudzi","Zvita"],"month_short":["Ndi","Kuk","Kur","Kub","Chv","Chk","Chg","Nya","Gun","Gum","Mb","Zvi"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "ZW" };
	icu.getCountryName = function() { return "Zimbabwe" };
	...
	icu.getLanguage = function() { return "sn" };
	icu.getLanguageName = function() { return "chiShona" };
