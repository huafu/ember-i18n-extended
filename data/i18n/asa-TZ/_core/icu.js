var container = {};(function() {
	...
	var dfs = {"am_pm":["icheheavo","ichamthi"],"day_name":["Jumapili","Jumatatu","Jumanne","Jumatano","Alhamisi","Ijumaa","Jumamosi"],"day_short":["Jpi","Jtt","Jnn","Jtn","Alh","Ijm","Jmo"],"era":["KM","BM"],"era_name":["Kabla yakwe Yethu","Baada yakwe Yethu"],"month_name":["Januari","Februari","Machi","Aprili","Mei","Juni","Julai","Agosti","Septemba","Oktoba","Novemba","Desemba"],"month_short":["Jan","Feb","Mac","Apr","Mei","Jun","Jul","Ago","Sep","Okt","Nov","Dec"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Tadhania" };
	...
	icu.getLanguage = function() { return "asa" };
	icu.getLanguageName = function() { return "Kipare" };
