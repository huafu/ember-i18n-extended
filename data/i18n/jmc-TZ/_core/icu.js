var container = {};(function() {
	...
	var dfs = {"am_pm":["utuko","kyiukonyi"],"day_name":["Jumapilyi","Jumatatuu","Jumanne","Jumatanu","Alhamisi","Ijumaa","Jumamosi"],"day_short":["Jpi","Jtt","Jnn","Jtn","Alh","Iju","Jmo"],"era":["KK","BK"],"era_name":["Kabla ya Kristu","Baada ya Kristu"],"month_name":["Januari","Februari","Machi","Aprilyi","Mei","Junyi","Julyai","Agusti","Septemba","Oktoba","Novemba","Desemba"],"month_short":["Jan","Feb","Mac","Apr","Mei","Jun","Jul","Ago","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "jmc" };
	icu.getLanguageName = function() { return "Kimachame" };
