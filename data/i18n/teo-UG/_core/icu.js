var container = {};(function() {
	...
	var dfs = {"am_pm":["Taparachu","Ebongi"],"day_name":["Nakaejuma","Nakaebarasa","Nakaare","Nakauni","Nakaung'on","Nakakany","Nakasabiti"],"day_short":["Jum","Bar","Aar","Uni","Ung","Kan","Sab"],"era":["KK","BK"],"era_name":["Kabla ya Christo","Baada ya Christo"],"month_name":["Orara","Omuk","Okwamg'","Odung'el","Omaruk","Omodok'king'ol","Ojola","Opedel","Osokosokoma","Otibar","Olabor","Opoo"],"month_short":["Rar","Muk","Kwa","Dun","Mar","Mod","Jol","Ped","Sok","Tib","Lab","Poo"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "teo" };
	icu.getLanguageName = function() { return "Kiteso" };
