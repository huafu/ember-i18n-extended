var container = {};(function() {
	...
	var dfs = {"am_pm":["n tufat","n tmeddit"],"day_name":["Yanass","Sanass","Kraḍass","Kuẓass","Samass","Sḍisass","Sayass"],"day_short":["Yan","San","Kraḍ","Kuẓ","Sam","Sḍis","Say"],"era":["snd. T.Ɛ","sld. T.Ɛ"],"era_name":["send talalit n Ɛisa","seld talalit n Ɛisa"],"month_name":["Yennayer","Fuṛar","Meɣres","Yebrir","Mayyu","Yunyu","Yulyu","Ɣuct","Ctembeṛ","Tubeṛ","Nunembeṛ","Duǧembeṛ"],"month_short":["Yen","Fur","Meɣ","Yeb","May","Yun","Yul","Ɣuc","Cte","Tub","Nun","Duǧ"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Lezzayer" };
	...
	icu.getLanguage = function() { return "kab" };
	icu.getLanguageName = function() { return "Taqbaylit" };
