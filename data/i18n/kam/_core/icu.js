var container = {};(function() {
	...
	var dfs = {"am_pm":["Ĩyakwakya","Ĩyawĩoo"],"day_name":["Wa kyumwa","Wa kwambĩlĩlya","Wa kelĩ","Wa katatũ","Wa kana","Wa katano","Wa thanthatũ"],"day_short":["Wky","Wkw","Wkl","Wtũ","Wkn","Wtn","Wth"],"era":["MY","IY"],"era_name":["Mbee wa Yesũ","Ĩtina wa Yesũ"],"month_name":["Mwai wa mbee","Mwai wa kelĩ","Mwai wa katatũ","Mwai wa kana","Mwai wa katano","Mwai wa thanthatũ","Mwai wa muonza","Mwai wa nyaanya","Mwai wa kenda","Mwai wa ĩkumi","Mwai wa ĩkumi na ĩmwe","Mwai wa ĩkumi na ilĩ"],"month_short":["Mbe","Kel","Ktũ","Kan","Ktn","Tha","Moo","Nya","Knd","Ĩku","Ĩkm","Ĩkl"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "kam" };
	icu.getLanguageName = function() { return "Kikamba" };
	icu.getLocale = function() { return "kam" };
	icu.getLocaleName = function() { return "Kikamba" };
