var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Lāpule","Poʻakahi","Poʻalua","Poʻakolu","Poʻahā","Poʻalima","Poʻaono"],"day_short":["LP","P1","P2","P3","P4","P5","P6"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["Ianuali","Pepeluali","Malaki","ʻApelila","Mei","Iune","Iulai","ʻAukake","Kepakemapa","ʻOkakopa","Nowemapa","Kekemapa"],"month_short":["Ian.","Pep.","Mal.","ʻAp.","Mei","Iun.","Iul.","ʻAu.","Kep.","ʻOk.","Now.","Kek."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "ʻAmelika Hui Pū ʻIa" };
	...
	icu.getLanguage = function() { return "haw" };
	icu.getLanguageName = function() { return "ʻŌlelo Hawaiʻi" };
	icu.getLocale = function() { return "haw-US" };
