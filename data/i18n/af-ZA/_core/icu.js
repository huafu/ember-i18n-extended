var container = {};(function() {
	...
	var dfs = {"am_pm":["vm.","nm."],"day_name":["Sondag","Maandag","Dinsdag","Woensdag","Donderdag","Vrydag","Saterdag"],"day_short":["So","Ma","Di","Wo","Do","Vr","Sa"],"era":["v.C.","n.C."],"era_name":["voor Christus","na Christus"],"month_name":["Januarie","Februarie","Maart","April","Mei","Junie","Julie","Augustus","September","Oktober","November","Desember"],"month_short":["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Aug","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Suid-Afrika" };
	...
	icu.getLanguage = function() { return "af" };
	icu.getLanguageName = function() { return "Afrikaans" };
	icu.getLocale = function() { return "af-ZA" };
