var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["lahadi","tɛɛnɛɛ","talata","alaba","aimisa","aijima","siɓiti"],"day_short":["lahadi","tɛɛnɛɛ","talata","alaba","aimisa","aijima","siɓiti"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["luukao kemã","ɓandaɓu","vɔɔ","fulu","goo","6","7","kɔnde","saah","galo","kenpkato ɓololɔ","luukao lɔma"],"month_short":["luukao kemã","ɓandaɓu","vɔɔ","fulu","goo","6","7","kɔnde","saah","galo","kenpkato ɓololɔ","luukao lɔma"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "Vai" };
	icu.getLocale = function() { return "vai-Latn" };
	icu.getLocaleName = function() { return "Vai (Latn)" };
