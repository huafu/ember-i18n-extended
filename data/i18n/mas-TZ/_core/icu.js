var container = {};(function() {
	...
	var dfs = {"am_pm":["Ɛnkakɛnyá","Ɛndámâ"],"day_name":["Jumapílí","Jumatátu","Jumane","Jumatánɔ","Alaámisi","Jumáa","Jumamósi"],"day_short":["Jpi","Jtt","Jnn","Jtn","Alh","Iju","Jmo"],"era":["MY","EY"],"era_name":["Meínō Yɛ́sʉ","Eínō Yɛ́sʉ"],"month_name":["Oladalʉ́","Arát","Ɔɛnɨ́ɔɨŋɔk","Olodoyíóríê inkókúâ","Oloilépūnyīē inkókúâ","Kújúɔrɔk","Mórusásin","Ɔlɔ́ɨ́bɔ́rárɛ","Kúshîn","Olgísan","Pʉshʉ́ka","Ntʉ́ŋʉ́s"],"month_short":["Dal","Ará","Ɔɛn","Doy","Lép","Rok","Sás","Bɔ́r","Kús","Gís","Shʉ́","Ntʉ́"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Tansania" };
	...
	icu.getLanguage = function() { return "mas" };
	icu.getLanguageName = function() { return "Maa" };
