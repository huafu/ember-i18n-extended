var container = {};(function() {
	...
	icu.getCountry = function() { return "GR" };
	icu.getCountryName = function() { return "Ελλάδα" };
	...
	icu.getLanguage = function() { return "el" };
	icu.getLanguageName = function() { return "Ελληνικά" };
	icu.getLocale = function() { return "el-GR" };
	icu.getLocaleName = function() { return "Ελληνικά (Ελλάδα)" };
