...
UrlUtil.getGlobalDirectory()=http://www.localeplanet.com/api/sr-Latn-ME/
UrlUtil.getGlobalPath()=http://www.localeplanet.com/api/sr-Latn-ME/currencymap.json
UrlUtil.getGlobalUrl()=http://www.localeplanet.com/api/sr-Latn-ME/currencymap.json?name=Y
UrlUtil.getLocalDirectory()=/api/sr-Latn-ME/
UrlUtil.getLocalFile()=currencymap.json
UrlUtil.getLocalPath()=/api/sr-Latn-ME/currencymap.json
UrlUtil.getLocalUrl()=/api/sr-Latn-ME/currencymap.json?name=Y
...
javax.servlet.forward.request_uri=/api/sr-Latn-ME/currencymap.json (type=java.lang.String)
javax.servlet.forward.servlet_path=/api/sr-Latn-ME/currencymap.json (type=java.lang.String)
...
org.mortbay.jetty.newSessionId=m0v7ni9zmak (type=java.lang.String)
org.tuckey.web.filters.urlrewrite.RuleMatched=true (type=java.lang.Boolean)
urlparam=sr-Latn-ME (type=java.lang.String)
