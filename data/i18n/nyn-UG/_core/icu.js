var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Sande","Orwokubanza","Orwakabiri","Orwakashatu","Orwakana","Orwakataano","Orwamukaaga"],"day_short":["SAN","ORK","OKB","OKS","OKN","OKT","OMK"],"era":["BC","AD"],"era_name":["Kurisito Atakaijire","Kurisito Yaijire"],"month_name":["Okwokubanza","Okwakabiri","Okwakashatu","Okwakana","Okwakataana","Okwamukaaga","Okwamushanju","Okwamunaana","Okwamwenda","Okwaikumi","Okwaikumi na kumwe","Okwaikumi na ibiri"],"month_short":["KBZ","KBR","KST","KKN","KTN","KMK","KMS","KMN","KMW","KKM","KNK","KNB"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "UG" };
	icu.getCountryName = function() { return "Uganda" };
	...
	icu.getLanguage = function() { return "nyn" };
	icu.getLanguageName = function() { return "Runyankore" };
