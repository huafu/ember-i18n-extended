var container = {};(function() {
	...
	var dfs = {"am_pm":["idiɓa","ebyámu"],"day_name":["éti","mɔ́sú","kwasú","mukɔ́sú","ŋgisú","ɗónɛsú","esaɓasú"],"day_short":["ét","mɔ́s","kwa","muk","ŋgi","ɗón","esa"],"era":["ɓ.Ys","mb.Ys"],"era_name":["ɓoso ɓwá yáɓe lá","mbúsa kwédi a Yés"],"month_name":["dimɔ́di","ŋgɔndɛ","sɔŋɛ","diɓáɓá","emiasele","esɔpɛsɔpɛ","madiɓɛ́díɓɛ́","diŋgindi","nyɛtɛki","mayésɛ́","tiníní","eláŋgɛ́"],"month_short":["di","ŋgɔn","sɔŋ","diɓ","emi","esɔ","mad","diŋ","nyɛt","may","tin","elá"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Cameroun" };
	...
	icu.getLanguage = function() { return "dua" };
	icu.getLanguageName = function() { return "duálá" };
