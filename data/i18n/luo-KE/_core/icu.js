var container = {};(function() {
	...
	var dfs = {"am_pm":["OD","OT"],"day_name":["Jumapil","Wuok Tich","Tich Ariyo","Tich Adek","Tich Ang'wen","Tich Abich","Ngeso"],"day_short":["JMP","WUT","TAR","TAD","TAN","TAB","NGS"],"era":["BC","AD"],"era_name":["Kapok Kristo obiro","Ka Kristo osebiro"],"month_name":["Dwe mar Achiel","Dwe mar Ariyo","Dwe mar Adek","Dwe mar Ang'wen","Dwe mar Abich","Dwe mar Auchiel","Dwe mar Abiriyo","Dwe mar Aboro","Dwe mar Ochiko","Dwe mar Apar","Dwe mar gi achiel","Dwe mar Apar gi ariyo"],"month_short":["DAC","DAR","DAD","DAN","DAH","DAU","DAO","DAB","DOC","DAP","DGI","DAG"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "luo" };
	icu.getLanguageName = function() { return "Dholuo" };
