var container = {};(function() {
	...
	var dfs = {"am_pm":["Luma lwa K","luma lwa p"],"day_name":["Ituku ja jumwa","Kuramuka jimweri","Kuramuka kawi","Kuramuka kadadu","Kuramuka kana","Kuramuka kasanu","Kifula nguwo"],"day_short":["Jum","Jim","Kaw","Kad","Kan","Kas","Ngu"],"era":["KK","BK"],"era_name":["Kabla ya Kristo","Baada ya Kristo"],"month_name":["Mori ghwa imbiri","Mori ghwa kawi","Mori ghwa kadadu","Mori ghwa kana","Mori ghwa kasanu","Mori ghwa karandadu","Mori ghwa mfungade","Mori ghwa wunyanya","Mori ghwa ikenda","Mori ghwa ikumi","Mori ghwa ikumi na imweri","Mori ghwa ikumi na iwi"],"month_short":["Imb","Kaw","Kad","Kan","Kas","Kar","Mfu","Wun","Ike","Iku","Imw","Iwi"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "KE" };
	icu.getCountryName = function() { return "Kenya" };
	...
	icu.getLanguage = function() { return "dav" };
	icu.getLanguageName = function() { return "Kitaita" };
