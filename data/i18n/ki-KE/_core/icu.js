var container = {};(function() {
	...
	var dfs = {"am_pm":["Kiroko","Hwaĩ-inĩ"],"day_name":["Kiumia","Njumatatũ","Njumaine","Njumatana","Aramithi","Njumaa","Njumamothi"],"day_short":["KMA","NTT","NMN","NMT","ART","NMA","NMM"],"era":["MK","TK"],"era_name":["Mbere ya Kristo","Thutha wa Kristo"],"month_name":["Njenuarĩ","Mwere wa kerĩ","Mwere wa gatatũ","Mwere wa kana","Mwere wa gatano","Mwere wa gatandatũ","Mwere wa mũgwanja","Mwere wa kanana","Mwere wa kenda","Mwere wa ikũmi","Mwere wa ikũmi na ũmwe","Ndithemba"],"month_short":["JEN","WKR","WGT","WKN","WTN","WTD","WMJ","WNN","WKD","WIK","WMW","DIT"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "ki" };
	icu.getLanguageName = function() { return "Gikuyu" };
	icu.getLocale = function() { return "ki-KE" };
	icu.getLocaleName = function() { return "Gikuyu (Kenya)" };
