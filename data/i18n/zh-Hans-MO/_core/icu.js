var container = {};(function() {
	...
	var dfs = {"am_pm":["上午","下午"],"day_name":["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],"day_short":["周日","周一","周二","周三","周四","周五","周六"],"era":["公元前","公元"],"era_name":["公元前","公元"],"month_name":["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],"month_short":["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],"order_full":"YMD","order_long":"YMD","order_medium":"YMD","order_short":"YMD"};
	...
	icu.getCountryName = function() { return "中国澳门特别行政区" };
	...
	icu.getLocale = function() { return "zh-Hans-MO" };
	icu.getLocaleName = function() { return "中文（简体中文、中国澳门特别行政区）" };
