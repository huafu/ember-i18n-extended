var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["kari","ntɛnɛ","tarata","araba","alamisa","juma","sibiri"],"day_short":["kar","ntɛ","tar","ara","ala","jum","sib"],"era":["J.-C. ɲɛ","ni J.-C."],"era_name":["jezu krisiti ɲɛ","jezu krisiti minkɛ"],"month_name":["zanwuye","feburuye","marisi","awirili","mɛ","zuwɛn","zuluye","uti","sɛtanburu","ɔkutɔburu","nowanburu","desanburu"],"month_short":["zan","feb","nar","awi","mɛ","zuw","zul","uti","sɛt","ɔku","now","des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "ML" };
	icu.getCountryName = function() { return "Mali" };
	...
	icu.getLanguage = function() { return "bm" };
	icu.getLanguageName = function() { return "bamanakan" };
