var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["якшанба","душанба","сешанба","чоршанба","пайшанба","жума","шанба"],"day_short":["Якш","Душ","Сеш","Чор","Пай","Жум","Шан"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["Январ","Феврал","Март","Апрел","Май","Июн","Июл","Август","Сентябр","Октябр","Ноябр","Декабр"],"month_short":["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Ўзбекистон" };
	...
	icu.getLanguageName = function() { return "Ўзбек" };
	icu.getLocale = function() { return "uz-Cyrl-UZ" };
	icu.getLocaleName = function() { return "Ўзбек (Cyrl, Ўзбекистон)" };
