var container = {};(function() {
	...
	var dfs = {"am_pm":["फुं","बेलासे"],"day_name":["रबिबार","समबार","मंगलबार","बुदबार","बिसथिबार","सुखुरबार","सुनिबार"],"day_short":["रबि","सम","मंगल","बुद","बिसथि","सुखुर","सुनि"],"era":["ईसा.पूर्व","सन"],"era_name":["ईसा.पूर्व","सन"],"month_name":["जानुवारी","फेब्रुवारी","मार्स","एफ्रिल","मे","जुन","जुलाइ","आगस्थ","सेबथेज्ब़र","अखथबर","नबेज्ब़र","दिसेज्ब़र"],"month_short":["जानुवारी","फेब्रुवारी","मार्स","एफ्रिल","मे","जुन","जुलाइ","आगस्थ","सेबथेज्ब़र","अखथबर","नबेज्ब़र","दिसेज्ब़र"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "brx" };
	icu.getLanguageName = function() { return "बड़ो" };
	icu.getLocale = function() { return "brx-IN" };
	icu.getLocaleName = function() { return "बड़ो (भारत)" };
