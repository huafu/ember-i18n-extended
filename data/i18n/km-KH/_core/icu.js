var container = {};(function() {
	...
	var dfs = {"am_pm":["ព្រឹក","ល្ងាច"],"day_name":["1","2","3","4","5","6","7"],"day_short":["អា","ច","អ","ពុ","ព្រ","សុ","ស"],"era":["មុន\u200Bគ.ស.","គ.ស."],"era_name":["មុន\u200Bគ្រិស្តសករាជ","គ្រិស្តសករាជ"],"month_name":["មករា","កុម្ភៈ","មិនា","មេសា","ឧសភា","មិថុនា","កក្កដា","សីហា","កញ្ញា","តុលា","វិច្ឆិកា","ធ្នូ"],"month_short":["១","២","៣","៤","៥","៦","៧","៨","៩","១០","១១","១២"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "KH" };
	icu.getCountryName = function() { return "កម្ពុជា" };
	...
	icu.getLanguage = function() { return "km" };
	icu.getLanguageName = function() { return "ភាសាខ្មែរ" };
