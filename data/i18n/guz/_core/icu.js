var container = {};(function() {
	...
	var dfs = {"am_pm":["Ma\/Mo","Mambia\/Mog"],"day_name":["Chumapiri","Chumatato","Chumaine","Chumatano","Aramisi","Ichuma","Esabato"],"day_short":["Cpr","Ctt","Cmn","Cmt","Ars","Icm","Est"],"era":["YA","YK"],"era_name":["Yeso ataiborwa","Yeso kaiboirwe"],"month_name":["Chanuari","Feburari","Machi","Apiriri","Mei","Juni","Chulai","Agosti","Septemba","Okitoba","Nobemba","Disemba"],"month_short":["Can","Feb","Mac","Apr","Mei","Jun","Cul","Agt","Sep","Okt","Nob","Dis"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "guz" };
	icu.getLanguageName = function() { return "Ekegusii" };
	icu.getLocale = function() { return "guz" };
	icu.getLocaleName = function() { return "Ekegusii" };
