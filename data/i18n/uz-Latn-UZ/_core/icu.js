var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["yakshanba","dushanba","seshanba","chorshanba","payshanba","cuma","shanba"],"day_short":["Yaksh","Dush","Sesh","Chor","Pay","Cum","Shan"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["Yanvar","Fevral","Mart","Aprel","May","Iyun","Iyul","Avgust","Sentyabr","Oktyabr","Noyabr","Dekabr"],"month_short":["Yanv","Fev","Mar","Apr","May","Iyun","Iyul","Avg","Sen","Okt","Noya","Dek"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "UZ" };
	icu.getCountryName = function() { return "Oʼzbekiston" };
	...
	icu.getLanguageName = function() { return "oʼzbekcha" };
	icu.getLocale = function() { return "uz-Latn-UZ" };
