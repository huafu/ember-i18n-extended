var container = {};(function() {
	...
	var dfs = {"am_pm":["RŨ","ŨG"],"day_name":["Kiumia","Muramuko","Wairi","Wethatu","Wena","Wetano","Jumamosi"],"day_short":["KIU","MRA","WAI","WET","WEN","WTN","JUM"],"era":["MK","NK"],"era_name":["Mbere ya Kristũ","Nyuma ya Kristũ"],"month_name":["Januarĩ","Feburuarĩ","Machi","Ĩpurũ","Mĩĩ","Njuni","Njuraĩ","Agasti","Septemba","Oktũba","Novemba","Dicemba"],"month_short":["JAN","FEB","MAC","ĨPU","MĨĨ","NJU","NJR","AGA","SPT","OKT","NOV","DEC"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "mer" };
	icu.getLanguageName = function() { return "Kĩmĩrũ" };
