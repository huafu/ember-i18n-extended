var container = {};(function() {
	...
	var dfs = {"am_pm":["am","pm"],"day_name":["dumingu","sigunda-fera","tersa-fera","kuarta-fera","kinta-fera","sesta-fera","sabadu"],"day_short":["dum","sig","ter","kua","kin","ses","sab"],"era":["AK","DK"],"era_name":["Antis di Kristu","Dispos di Kristu"],"month_name":["Janeru","Fevereru","Marsu","Abril","Maiu","Junhu","Julhu","Agostu","Setenbru","Otubru","Nuvenbru","Dizenbru"],"month_short":["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Otu","Nuv","Diz"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "kea" };
	icu.getLanguageName = function() { return "kabuverdianu" };
	icu.getLocale = function() { return "kea" };
	icu.getLocaleName = function() { return "kabuverdianu" };
