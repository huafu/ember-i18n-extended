var container = {};(function() {
	...
	var dfs = {"am_pm":["قبل\u200Cازظهر","بعدازظهر"],"day_name":["یکشنبه","دوشنبه","سه\u200Cشنبه","چهارشنبه","پنجشنبه","جمعه","شنبه"],"day_short":["یکشنبه","دوشنبه","سه\u200Cشنبه","چهارشنبه","پنجشنبه","جمعه","شنبه"],"era":["ق.م.","م."],"era_name":["قبل از میلاد","میلادی"],"month_name":["ژانویهٔ","فوریهٔ","مارس","آوریل","مهٔ","ژوئن","ژوئیهٔ","اوت","سپتامبر","اکتبر","نوامبر","دسامبر"],"month_short":["ژانویهٔ","فوریهٔ","مارس","آوریل","مهٔ","ژوئن","ژوئیهٔ","اوت","سپتامبر","اکتبر","نوامبر","دسامبر"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "IR" };
	icu.getCountryName = function() { return "ایران" };
	...
	icu.getLanguage = function() { return "fa" };
	icu.getLanguageName = function() { return "فارسی" };
