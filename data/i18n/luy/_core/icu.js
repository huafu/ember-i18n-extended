var container = {};(function() {
	...
	var dfs = {"am_pm":["a.m.","p.m."],"day_name":["Jumapiri","Jumatatu","Jumanne","Jumatano","Murwa wa Kanne","Murwa wa Katano","Jumamosi"],"day_short":["J2","J3","J4","J5","Al","Ij","J1"],"era":["BC","AD"],"era_name":["Imberi ya Kuuza Kwa","Muhiga Kuvita Kuuza"],"month_name":["Januari","Februari","Machi","Aprili","Mei","Juni","Julai","Agosti","Septemba","Oktoba","Novemba","Desemba"],"month_short":["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Ago","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "luy" };
	icu.getLanguageName = function() { return "Luluhia" };
	icu.getLocale = function() { return "luy" };
	icu.getLocaleName = function() { return "Luluhia" };
