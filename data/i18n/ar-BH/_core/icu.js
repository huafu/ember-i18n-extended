var container = {};(function() {
	...
	icu.getCountry = function() { return "BH" };
	icu.getCountryName = function() { return "البحرين" };
	...
	icu.getLocale = function() { return "ar-BH" };
	icu.getLocaleName = function() { return "العربية (البحرين)" };
