var container = {};(function() {
	...
	var dfs = {"am_pm":["uluchelo","akasuba"],"day_name":["Pa Mulungu","Palichimo","Palichibuli","Palichitatu","Palichine","Palichisano","Pachibelushi"],"day_short":["Pa Mulungu","Palichimo","Palichibuli","Palichitatu","Palichine","Palichisano","Pachibelushi"],"era":["BC","AD"],"era_name":["Before Yesu","After Yesu"],"month_name":["Januari","Februari","Machi","Epreo","Mei","Juni","Julai","Ogasti","Septemba","Oktoba","Novemba","Disemba"],"month_short":["Jan","Feb","Mac","Epr","Mei","Jun","Jul","Oga","Sep","Okt","Nov","Dis"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "ZM" };
	icu.getCountryName = function() { return "Zambia" };
	...
	icu.getLanguage = function() { return "bem" };
	icu.getLanguageName = function() { return "Ichibemba" };
