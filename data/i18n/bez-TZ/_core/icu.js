var container = {};(function() {
	...
	var dfs = {"am_pm":["pamilau","pamunyi"],"day_name":["pa mulungu","pa shahuviluha","pa hivili","pa hidatu","pa hitayi","pa hihanu","pa shahulembela"],"day_short":["Mul","Vil","Hiv","Hid","Hit","Hih","Lem"],"era":["KM","BM"],"era_name":["Kabla ya Mtwaa","Baada ya Mtwaa"],"month_name":["pa mwedzi gwa hutala","pa mwedzi gwa wuvili","pa mwedzi gwa wudatu","pa mwedzi gwa wutai","pa mwedzi gwa wuhanu","pa mwedzi gwa sita","pa mwedzi gwa saba","pa mwedzi gwa nane","pa mwedzi gwa tisa","pa mwedzi gwa kumi","pa mwedzi gwa kumi na moja","pa mwedzi gwa kumi na mbili"],"month_short":["Hut","Vil","Dat","Tai","Han","Sit","Sab","Nan","Tis","Kum","Kmj","Kmb"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "TZ" };
	icu.getCountryName = function() { return "Hutanzania" };
	...
	icu.getLanguage = function() { return "bez" };
	icu.getLanguageName = function() { return "Hibena" };
