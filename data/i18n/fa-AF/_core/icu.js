var container = {};(function() {
	...
	var dfs = {"am_pm":["قبل\u200Cازظهر","بعدازظهر"],"day_name":["یکشنبه","دوشنبه","سه\u200Cشنبه","چهارشنبه","پنجشنبه","جمعه","شنبه"],"day_short":["یکشنبه","دوشنبه","سه\u200Cشنبه","چهارشنبه","پنجشنبه","جمعه","شنبه"],"era":["ق.م.","م."],"era_name":["قبل از میلاد","میلادی"],"month_name":["جنوری","فبروری","مارچ","اپریل","می","جون","جولای","اگست","سپتمبر","اکتوبر","نومبر","دسمبر"],"month_short":["جنو","فوریهٔ","مارس","آوریل","مـی","ژوئن","جول","اوت","سپتامبر","اکتبر","نوامبر","دسم"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "دری" };
