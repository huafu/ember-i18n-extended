var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Sabbiiti","Balaza","Lwakubiri","Lwakusatu","Lwakuna","Lwakutaano","Lwamukaaga"],"day_short":["Sab","Bal","Lw2","Lw3","Lw4","Lw5","Lw6"],"era":["BC","AD"],"era_name":["Kulisito nga tannaza","Bukya Kulisito Azaal"],"month_name":["Janwaliyo","Febwaliyo","Marisi","Apuli","Maayi","Juuni","Julaayi","Agusito","Sebuttemba","Okitobba","Novemba","Desemba"],"month_short":["Jan","Feb","Mar","Apu","Maa","Juu","Jul","Agu","Seb","Oki","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Yuganda" };
	...
	icu.getLanguage = function() { return "lg" };
	icu.getLanguageName = function() { return "Luganda" };
