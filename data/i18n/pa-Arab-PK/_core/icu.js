var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["اتوار","پیر","منگل","بُدھ","جمعرات","جمعہ","ہفتہ"],"day_short":["اتوار","پیر","منگل","بُدھ","جمعرات","جمعہ","ہفتہ"],"era":["BCE","CE"],"era_name":["ايساپورو","سں"],"month_name":["جنوری","فروری","مارچ","اپریل","مئ","جون","جولائی","اگست","ستمبر","اکتوبر","نومبر","دسمبر"],"month_short":["جنوری","فروری","مارچ","اپریل","مئ","جون","جولائی","اگست","ستمبر","اکتوبر","نومبر","دسمبر"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "PK" };
	icu.getCountryName = function() { return "پکستان" };
	...
	icu.getLanguageName = function() { return "پنجاب" };
	icu.getLocale = function() { return "pa-Arab-PK" };
	icu.getLocaleName = function() { return "پنجاب (العربية, پکستان)" };
