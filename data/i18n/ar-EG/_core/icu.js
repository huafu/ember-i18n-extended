var container = {};(function() {
	...
	icu.getCountry = function() { return "EG" };
	icu.getCountryName = function() { return "مصر" };
	...
	icu.getLocale = function() { return "ar-EG" };
	icu.getLocaleName = function() { return "العربية (مصر)" };
