var container = {};(function() {
	...
	var dfs = {"am_pm":["ንጉሆ ሰዓተ","ድሕር ሰዓት"],"day_name":["ሰንበት","ሰኑይ","ሰሉስ","ረቡዕ","ሓሙስ","ዓርቢ","ቀዳም"],"day_short":["ሰንበት","ሰኑይ","ሰሉስ","ረቡዕ","ሓሙስ","ዓርቢ","ቀዳም"],"era":["ዓ\/ዓ","ዓ\/ም"],"era_name":["ዓ\/ዓ","ዓ\/ም"],"month_name":["ጥሪ","ለካቲት","መጋቢት","ሚያዝያ","ግንቦት","ሰነ","ሓምለ","ነሓሰ","መስከረም","ጥቅምቲ","ሕዳር","ታሕሳስ"],"month_short":["ጥሪ","ለካቲ","መጋቢ","ሚያዝ","ግንቦ","ሰነ","ሓምለ","ነሓሰ","መስከ","ጥቅም","ሕዳር","ታሕሳ"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "ER" };
	icu.getCountryName = function() { return "ER" };
	...
	icu.getLanguage = function() { return "ti" };
	icu.getLanguageName = function() { return "ትግርኛ" };
	icu.getLocale = function() { return "ti-ER" };
	icu.getLocaleName = function() { return "ትግርኛ (ER)" };
