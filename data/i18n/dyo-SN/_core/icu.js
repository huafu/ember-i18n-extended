var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Dimas","Teneŋ","Talata","Alarbay","Aramisay","Arjuma","Sibiti"],"day_short":["Dim","Ten","Tal","Ala","Ara","Arj","Sib"],"era":["ArY","AtY"],"era_name":["Ariŋuu Yeesu","Atooŋe Yeesu"],"month_name":["Sanvie","Fébirie","Mars","Aburil","Mee","Sueŋ","Súuyee","Ut","Settembar","Oktobar","Novembar","Disambar"],"month_short":["Sa","Fe","Ma","Ab","Me","Su","Sú","Ut","Se","Ok","No","De"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Senegal" };
	...
	icu.getLanguage = function() { return "dyo" };
	icu.getLanguageName = function() { return "joola" };
