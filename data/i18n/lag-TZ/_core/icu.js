var container = {};(function() {
	...
	var dfs = {"am_pm":["TOO","MUU"],"day_name":["Jumapíiri","Jumatátu","Jumaíne","Jumatáano","Alamíisi","Ijumáa","Jumamóosi"],"day_short":["Píili","Táatu","Íne","Táano","Alh","Ijm","Móosi"],"era":["KSA","KA"],"era_name":["Kɨrɨsitʉ sɨ anavyaal","Kɨrɨsitʉ akavyaalwe"],"month_name":["Kʉfúngatɨ","Kʉnaanɨ","Kʉkeenda","Kwiikumi","Kwiinyambála","Kwiidwaata","Kʉmʉʉnchɨ","Kʉvɨɨrɨ","Kʉsaatʉ","Kwiinyi","Kʉsaano","Kʉsasatʉ"],"month_short":["Fúngatɨ","Naanɨ","Keenda","Ikúmi","Inyambala","Idwaata","Mʉʉnchɨ","Vɨɨrɨ","Saatʉ","Inyi","Saano","Sasatʉ"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Taansanía" };
	...
	icu.getLanguage = function() { return "lag" };
	icu.getLanguageName = function() { return "Kɨlaangi" };
