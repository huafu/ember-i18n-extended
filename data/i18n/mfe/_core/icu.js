var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["dimans","lindi","mardi","merkredi","zedi","vandredi","samdi"],"day_short":["dim","lin","mar","mer","ze","van","sam"],"era":["av. Z-K","ap. Z-K"],"era_name":["avan Zezi-Krist","apre Zezi-Krist"],"month_name":["zanvie","fevriye","mars","avril","me","zin","zilye","out","septam","oktob","novam","desam"],"month_short":["zan","fev","mar","avr","me","zin","zil","out","sep","okt","nov","des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "mfe" };
	icu.getLanguageName = function() { return "kreol morisien" };
	icu.getLocale = function() { return "mfe" };
	icu.getLocaleName = function() { return "kreol morisien" };
