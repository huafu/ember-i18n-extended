var container = {};(function() {
	...
	var dfs = {"am_pm":["A.M.","P.M."],"day_name":["Mbọsị Ụka","Mọnde","Tiuzdee","Wenezdee","Tọọzdee","Fraịdee","Satọdee"],"day_short":["Ụka","Mọn","Tiu","Wen","Tọọ","Fraị","Sat"],"era":["T.K.","A.K."],"era_name":["Tupu Kristi","Afọ Kristi"],"month_name":["Jenụwarị","Febrụwarị","Maachị","Eprel","Mee","Juun","Julaị","Ọgọọst","Septemba","Ọktoba","Novemba","Disemba"],"month_short":["Jen","Feb","Maa","Epr","Mee","Juu","Jul","Ọgọ","Sep","Ọkt","Nov","Dis"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
