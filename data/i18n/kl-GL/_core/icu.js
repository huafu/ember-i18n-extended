var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["sabaat","ataasinngorneq","marlunngorneq","pingasunngorneq","sisamanngorneq","tallimanngorneq","arfininngorneq"],"day_short":["sab","ata","mar","pin","sis","tal","arf"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["januari","februari","martsi","aprili","maji","juni","juli","augustusi","septemberi","oktoberi","novemberi","decemberi"],"month_short":["jan","feb","mar","apr","maj","jun","jul","aug","sep","okt","nov","dec"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "GL" };
	icu.getCountryName = function() { return "Kalaallit Nunaat" };
	...
	icu.getLanguage = function() { return "kl" };
	icu.getLanguageName = function() { return "kalaallisut" };
