var container = {};(function() {
	...
	var dfs = {"am_pm":["Dinda","Dilolo"],"day_name":["Lumingu","Nkodya","Ndàayà","Ndangù","Njòwa","Ngòvya","Lubingu"],"day_short":["Lum","Nko","Ndy","Ndg","Njw","Ngv","Lub"],"era":["kmp. Y.K.","kny. Y. K."],"era_name":["Kumpala kwa Yezu Kli","Kunyima kwa Yezu Kli"],"month_name":["Ciongo","Lùishi","Lusòlo","Mùuyà","Lumùngùlù","Lufuimi","Kabàlàshìpù","Lùshìkà","Lutongolo","Lungùdi","Kaswèkèsè","Ciswà"],"month_short":["Cio","Lui","Lus","Muu","Lum","Luf","Kab","Lush","Lut","Lun","Kas","Cis"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Ditunga wa Kongu" };
	...
	icu.getLanguage = function() { return "lu" };
	icu.getLanguageName = function() { return "Tshiluba" };
