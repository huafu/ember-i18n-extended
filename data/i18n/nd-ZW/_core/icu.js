var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Sonto","Mvulo","Sibili","Sithathu","Sine","Sihlanu","Mgqibelo"],"day_short":["Son","Mvu","Sib","Sit","Sin","Sih","Mgq"],"era":["BC","AD"],"era_name":["UKristo angakabuyi","Ukristo ebuyile"],"month_name":["Zibandlela","Nhlolanja","Mbimbitho","Mabasa","Nkwenkwezi","Nhlangula","Ntulikazi","Ncwabakazi","Mpandula","Mfumfu","Lwezi","Mpalakazi"],"month_short":["Zib","Nhlo","Mbi","Mab","Nkw","Nhla","Ntu","Ncw","Mpan","Mfu","Lwe","Mpal"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "nd" };
	icu.getLanguageName = function() { return "isiNdebele" };
