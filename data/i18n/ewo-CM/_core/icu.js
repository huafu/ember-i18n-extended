var container = {};(function() {
	...
	var dfs = {"am_pm":["kíkíríg","ngǝgógǝle"],"day_name":["sɔ́ndɔ","mɔ́ndi","sɔ́ndɔ mǝlú mǝ́bɛ̌","sɔ́ndɔ mǝlú mǝ́lɛ́","sɔ́ndɔ mǝlú mǝ́nyi","fúladé","séradé"],"day_short":["sɔ́n","mɔ́n","smb","sml","smn","fúl","sér"],"era":["oyk","ayk"],"era_name":["osúsúa Yésus kiri","ámvus Yésus Kirís"],"month_name":["ngɔn osú","ngɔn bɛ̌","ngɔn lála","ngɔn nyina","ngɔn tána","ngɔn samǝna","ngɔn zamgbála","ngɔn mwom","ngɔn ebulú","ngɔn awóm","ngɔn awóm ai dziá","ngɔn awóm ai bɛ̌"],"month_short":["ngo","ngb","ngl","ngn","ngt","ngs","ngz","ngm","nge","nga","ngad","ngab"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Kamǝrún" };
	...
	icu.getLanguage = function() { return "ewo" };
	icu.getLanguageName = function() { return "ewondo" };
	icu.getLocale = function() { return "ewo-CM" };
	icu.getLocaleName = function() { return "ewondo (Kamǝrún)" };
