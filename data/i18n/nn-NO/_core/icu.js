var container = {};(function() {
	...
	var dfs = {"am_pm":["formiddag","ettermiddag"],"day_name":["søndag","måndag","tysdag","onsdag","torsdag","fredag","laurdag"],"day_short":["sø.","må.","ty.","on.","to.","fr.","la."],"era":["f.Kr.","e.Kr."],"era_name":["f.Kr.","e.Kr."],"month_name":["januar","februar","mars","april","mai","juni","juli","august","september","oktober","november","desember"],"month_short":["jan.","feb.","mars","apr.","mai","juni","juli","aug.","sep.","okt.","nov.","des."],"order_full":"DMY","order_long":"DMY","order_medium":"DMY","order_short":"DMY"};
	...
	icu.getCountryName = function() { return "Noreg" };
	...
	icu.getLanguage = function() { return "nn" };
	icu.getLanguageName = function() { return "nynorsk" };
	icu.getLocale = function() { return "nn-NO" };
	icu.getLocaleName = function() { return "nynorsk (Noreg)" };
