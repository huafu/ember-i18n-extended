var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Ku cyumweru","Kuwa mbere","Kuwa kabiri","Kuwa gatatu","Kuwa kane","Kuwa gatanu","Kuwa gatandatu"],"day_short":["cyu.","mbe.","kab.","gtu.","kan.","gnu.","gnd."],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["Mutarama","Gashyantare","Werurwe","Mata","Gicuransi","Kamena","Nyakanga","Kanama","Nzeli","Ukwakira","Ugushyingo","Ukuboza"],"month_short":["mut.","gas.","wer.","mat.","gic.","kam.","nya.","kan.","nze.","ukw.","ugu.","uku."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
