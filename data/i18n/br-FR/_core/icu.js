var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Sul","Lun","Meurzh","Mercʼher","Yaou","Gwener","Sadorn"],"day_short":["sul","lun","meu.","mer.","yaou","gwe.","sad."],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["Genver","Cʼhwevrer","Meurzh","Ebrel","Mae","Mezheven","Gouere","Eost","Gwengolo","Here","Du","Kerzu"],"month_short":["Gen","Cʼhwe","Meur","Ebr","Mae","Mezh","Goue","Eost","Gwen","Here","Du","Ker"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "FR" };
	icu.getCountryName = function() { return "Frañs" };
	...
	icu.getLanguage = function() { return "br" };
	icu.getLanguageName = function() { return "brezhoneg" };
	icu.getLocale = function() { return "br-FR" };
	icu.getLocaleName = function() { return "brezhoneg (Frañs)" };
