var container = {};(function() {
	...
	var dfs = {"am_pm":["am","sm"],"day_name":["dumengia","glindesdi","mardi","mesemna","gievgia","venderdi","sonda"],"day_short":["du","gli","ma","me","gie","ve","so"],"era":["av. Cr.","s. Cr."],"era_name":["avant Cristus","suenter Cristus"],"month_name":["schaner","favrer","mars","avrigl","matg","zercladur","fanadur","avust","settember","october","november","december"],"month_short":["schan.","favr.","mars","avr.","matg","zercl.","fan.","avust","sett.","oct.","nov.","dec."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountry = function() { return "CH" };
	icu.getCountryName = function() { return "Svizra" };
	...
	icu.getLanguage = function() { return "rm" };
	icu.getLanguageName = function() { return "rumantsch" };
