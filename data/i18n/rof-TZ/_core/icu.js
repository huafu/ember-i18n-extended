var container = {};(function() {
	...
	var dfs = {"am_pm":["kang'ama","kingoto"],"day_name":["Ijumapili","Ijumatatu","Ijumanne","Ijumatano","Alhamisi","Ijumaa","Ijumamosi"],"day_short":["Ijp","Ijt","Ijn","Ijtn","Alh","Iju","Ijm"],"era":["KM","BM"],"era_name":["Kabla ya Mayesu","Baada ya Mayesu"],"month_name":["Mweri wa kwanza","Mweri wa kaili","Mweri wa katatu","Mweri wa kaana","Mweri wa tanu","Mweri wa sita","Mweri wa saba","Mweri wa nane","Mweri wa tisa","Mweri wa ikumi","Mweri wa ikumi na moja","Mweri wa ikumi na mbili"],"month_short":["M1","M2","M3","M4","M5","M6","M7","M8","M9","M10","M11","M12"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Tanzania" };
	...
	icu.getLanguage = function() { return "rof" };
	icu.getLanguageName = function() { return "Kihorombo" };
