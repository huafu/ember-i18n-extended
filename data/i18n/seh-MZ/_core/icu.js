var container = {};(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Dimingu","Chiposi","Chipiri","Chitatu","Chinai","Chishanu","Sabudu"],"day_short":["Dim","Pos","Pir","Tat","Nai","Sha","Sab"],"era":["AC","AD"],"era_name":["Antes de Cristo","Anno Domini"],"month_name":["Janeiro","Fevreiro","Marco","Abril","Maio","Junho","Julho","Augusto","Setembro","Otubro","Novembro","Decembro"],"month_short":["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Aug","Set","Otu","Nov","Dec"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "seh" };
	icu.getLanguageName = function() { return "sena" };
	icu.getLocale = function() { return "seh-MZ" };
	icu.getLocaleName = function() { return "sena (Moçambique)" };
