var container = {};(function() {
	...
	icu.getCountry = function() { return "LY" };
	icu.getCountryName = function() { return "ليبيا" };
	...
	icu.getLocale = function() { return "ar-LY" };
	icu.getLocaleName = function() { return "العربية (ليبيا)" };
