var container = {};(function() {
	...
	var dfs = {"am_pm":["Munkyo","Eigulo"],"day_name":["Sabiiti","Balaza","Owokubili","Owokusatu","Olokuna","Olokutaanu","Olomukaaga"],"day_short":["Sabi","Bala","Kubi","Kusa","Kuna","Kuta","Muka"],"era":["AZ","AF"],"era_name":["Kulisto nga azilawo","Kulisto nga affile"],"month_name":["Janwaliyo","Febwaliyo","Marisi","Apuli","Maayi","Juuni","Julaayi","Agusito","Sebuttemba","Okitobba","Novemba","Desemba"],"month_short":["Jan","Feb","Mar","Apu","Maa","Juu","Jul","Agu","Seb","Oki","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "xog" };
	icu.getLanguageName = function() { return "Olusoga" };
